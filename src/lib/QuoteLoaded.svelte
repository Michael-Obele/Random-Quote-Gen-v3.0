...
>
  ...
  >
    random
    <i class="fa-solid fa-arrows-spin m-1 ml-2 h-5 w-5 stroke-2 group-hover:animate-spin-once"></i>
...
<section class="absolute bottom-0 z-50 flex h-[25vh] w-full flex-col bg-slate-200 p-12 px-[10rem] dark:bg-gray-800">
  <h3 class="text-lg font-bold capitalize text-white md:text-2xl">{text.author}</h3>
  <p class="text-sm font-semibold uppercase text-gray-400 md:text-lg">{text.tags}</p>
</section> 